...
namespace Isad154_project.Classes
{
    public class Tasks
    {
        ...
        {
            string newJson;
            using (StreamReader r = new StreamReader(@"C:/Users/louis/Desktop/combined project/ISAD154/Isad154_project/App_Data/tasks.json"))
            {
            ...
            File.WriteAllText(@"C:/Users/louis/Desktop/combined project/ISAD154/Isad154_project/App_Data/tasks.json", newJson);
        }
