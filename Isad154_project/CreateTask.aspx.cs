...
namespace Isad154_project
{
    public partial class CreateTask : System.Web.UI.Page
    {
        ...
        {
            using (StreamReader t = new StreamReader(@"C:/Users/louis/Desktop/combined project/ISAD154/Isad154_project/App_Data/tasks.json"))
            {
        ...
        {
            using (StreamReader p = new StreamReader(@"C:/Users/louis/Desktop/combined project/ISAD154/Isad154_project/App_Data/parts.json"))
            {
        ...
        {
            foreach (Parts p in Parts.getParts())
            {
                drpdwnParts.Items.Add(p.PartName);
            }
        }
    }
}